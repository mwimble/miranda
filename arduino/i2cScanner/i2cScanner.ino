// Lysander expected addresses:
//  Bus 18_19
//  0x3D  TOF Front Left
//  0x3E  TOF Front Right
//  0x3F  TOF Back Left
//  0x40  TOF Back Right
//
//  BUS 37_38
//  0x28  BNO055 IMU
//  0x48  TMP102 Sparkfun Left Motor Sensor
//  0x49  TMP102 Sparkfun Right Motor Sensor
...
void loop()
{
    // Scan I2C addresses
    //
    if(true/*digitalRead(12) == LOW || digitalRead(11) == LOW*/)
    {
        uint8_t all = false;//(digitalRead(11) == LOW);
